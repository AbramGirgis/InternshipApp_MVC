...
INSERT INTO `filesuser` (`fileId`, `userID`, `type`, `status`, `description`, `lastUpdate`, `extension`) VALUES
(8, '2203102', 'image', 1, '', '2022-10-24 03:02:55', 'png'),
(9, '2203102', 'cv', 1, 'some file description', '2022-10-24 03:03:35', 'pdf');
...
(5, 'Font End Developer', 'Computer Science', '', '', 'Perform, plan and co-ordinate the following for complex studies: (i) the programming, testing, and documentation of statistical programs for use in creating statistical tables, figures, and listing summaries and (ii) the programming of analysis databases (derived datasets) and transfers of data for internal and external clients. May perform and plan the programming of database quality control checks.Perform, plan and co-ordinate the following for complex studies: (i) the programming, testing, and documentation of statistical programs for use in creating statistical tables, figures, and listing summaries and (ii) the programming of analysis databases (derived datasets) and transfers of data for internal and external clients. May perform and plan the programming of database quality control checks.', 'Perform, plan and co-ordinate the following for complex studies: (i) the programming, testing, and documentation of statistical programs for use in creating statistical tables, figures, and listing summaries and (ii) the programming of analysis databases (derived datasets) and transfers of data for internal and external clients. May perform and plan the programming of database quality control checks.', '2022-08-27', '2022-11-16', '2022-10-23 01:19:55', 1, 1, 1);
...
('343', 'aaa', 'bbb', '2002-10-23', 'f@t.c', '767', 30, '4343231111', NULL, '2022-10-22 23:45:07', '2022-10-22 23:45:07', 3413, 1, 2),
...
('2203102', 2, '2022-08-16 04:00:00', 'applied');
...
--
ALTER TABLE `companyrepresentative`
  MODIFY `representativeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
