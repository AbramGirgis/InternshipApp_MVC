...
></span
    ...
    <div class="underNav">
        ...
        <!-- Search -->
        <form action="<?php echo ROOTURL."/internship/search/"?>" style="padding: 16px; float: right;" method="post">
            <input type="text" placeholder="Search Internships.." name="searchWord" style="width: 6in;">
